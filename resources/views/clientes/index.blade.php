    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="alert alert-success">
          ...
          No se tiene ningun cliente registrado <a href="#"
          class="alert-link">Registre clientes</a>
        </div>
        @else
          @if(session('mensaje'))
          <div class="alert alert-success">
          ...
          <table id="tabla" class="table table-bordered table-striped dt-responsive tablas" style="width:100%">
            ...
            <tr>
              ...
              <td class="center">
                ...
                <button type="submit" idCliente="{{ $cliente->ID }}" estadoCliente="{{ $cliente->Estado }}" data-token="{{ csrf_token() }}" @if($cliente->Estado == "1") class="btn btn-sm btnActivar btn-success" @else class="btn btn-sm btnActivar btn-danger" @endif>
              ...
              <td class="center">
                    ...
                    <!-- Button modal edit -->
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-update{{ $cliente->ID }}">
